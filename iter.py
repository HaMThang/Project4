...
document = loader.modules[FILE_TYPE].load_document('pdf-struct-dataset/contract_pdf_en/raw/2_waycda.pdf', None, None)
...
#print(len(to_paragraphs(pred)[0]))
print(pred.__dict__['texts'])
print(len(pred.__dict__['texts']))
#print(type(to_paragraphs(pred)[0][0]))

#print(to_tree(pred)[0]['text'])
